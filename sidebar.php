        ...
        <ul class="list-unstyled">
            ...
            <li>
                ...
                foreach ($db->recordsArray() as $project) {
                    echo "<a href=\"#".$project["project_name"]."\" data-toggle=\"collapse\"><i class=\"fas fa-suitcase\"></i>  ".$project["project_name"]."</a>
                    ...
                    foreach ($db->recordsArray() as $core) {
                        echo "<a href=\"#".$core["core_id"]."\" data-toggle=\"collapse\"><i class=\"fa fa-folder\"></i> ".$core["core_id"]."</a>
                        ...
                        foreach ($db->recordsArray() as $sample) {
                            echo "<li><a href=\"sample.php?project=".$project["project_name"]."&core=".$core["core_id"]."&sample=".$sample["sample_id"]."\"><i class=\"fa fa-bolt\"></i> ".$sample["sample_id"]."</a></li>";
                        }
