...
class Project_Form extends Add_New_Post_Form {
    ...
    protected function delete() {
        ...
        $specimens = $this->db->selectRows("specimens", array('project_id' => Mysql::sqlValue($_GET["project_id"])));
        parent::delete(); // TODO: Change the autogenerated stub
        if ($specimens && !$this->db->error()) {
            foreach ($specimens as $spec) {
                delete_files($image_folder . '/' . $_GET["project_id"] . '/' . $spec["specimen_id"] . "/");
            }
        }
    }
}
